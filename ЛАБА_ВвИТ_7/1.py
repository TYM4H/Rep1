...
employee = Employee('Владимир', 1)
manager = Manager('Миша', 2, 'HR')
technician = Technician('Максим', 3, 'Сварщик')
tech_manager = TechManager('Намжил', 4, 'ИТ', 'Системное администрирование')
